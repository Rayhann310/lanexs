...
INSERT IGNORE INTO `companies` (`id`, `name`, `address`, `phone`) VALUES
(1, 'LANEX Logistics', 'Gedung LANEX, Jl. Jend. Sudirman No. 1, Jakarta', '021-1234567');

-- Insert Default Branch (HQ)
INSERT IGNORE INTO `branches` (`id`, `company_id`, `code`, `name`, `type`, `city`) VALUES
...
INSERT IGNORE INTO `users` (`company_id`, `branch_id`, `role_id`, `username`, `password`, `fullname`, `email`) VALUES
