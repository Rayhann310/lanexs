...
.lp-hero { background: linear-gradient(135deg, #f59e0b 0%, #d97706 40%, #b45309 100%); }
...
<!-- ====================================
     HERO SECTION
     ==================================== -->
<section class="lp-hero pt-32 pb-24 relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-amber-600/80 via-amber-500/40 to-transparent pointer-events-none"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-2xl" data-aos="fade-up">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?= BASE_URL ?>/tracking" class="px-6 py-3 bg-white text-amber-600 font-bold rounded-xl hover:bg-amber-50 transition-all hover:scale-105 shadow-lg flex items-center gap-2">
