...
<section class="py-20 bg-slate-50 dark:bg-slate-900 transition-colors">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <!-- Graphic / Timeline Side -->
            <div class="lg:col-span-5 order-2 lg:order-1" data-aos="fade-right">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/20 group">
                    <img src="https://images.unsplash.com/photo-1578575437130-527eed3abbec?q=80&w=2070&auto=format&fit=crop" alt="LANEXS Sejarah" class="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent"></div>
                    <div class="absolute bottom-0 left-0 p-8">
                        <div class="bg-primary text-white text-xs font-bold uppercase tracking-wider py-1.5 px-3 rounded-full inline-block mb-3">Sejak 2025</div>
                        <h3 class="text-white font-heading font-bold text-2xl">Membangun Jaringan<br>Logistik Nusantara</h3>
                    </div>
                </div>
                
                <div class="mt-8 bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm flex items-center space-x-4">
                    <div class="w-12 h-12 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center shrink-0">
                        <i class="bi bi-rocket-takeoff text-xl"></i>
                    </div>
                    <div>
                        <h4 class="font-bold text-slate-800 dark:text-white">Inovasi Terus Menerus</h4>
                        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Kami berdedikasi untuk terus beradaptasi dengan teknologi terbaru.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-7 order-1 lg:order-2" data-aos="fade-left">
                ...
                <div class="mt-6 flex justify-end">
                    <a href="<?= BASE_URL ?>/settings/pages/edit/<?= $page['id'] ?>" class="flex items-center px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-xl shadow-md hover:bg-primaryHover transition-colors">
                        <i class="bi bi-pencil-fill mr-2"></i> Edit Teks Sejarah
                    </a>
                </div>
                <?php endif; ?>
            </div>
