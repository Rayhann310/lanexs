    ...
    <div x-show="statusModal" 
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto"
            ...
            <form :action="statusFormAction" method="POST" enctype="multipart/form-data" class="px-6 pb-6 space-y-4" id="statusUpdateForm">
                ...
                <!-- Branch or City -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Lokasi Update <span class="text-slate-400 font-normal">(opsional)</span></label>
                    <div class="flex items-center gap-4 mb-3">
                        <label class="inline-flex items-center">
                            <input type="radio" x-model="statusData.location_type" value="branch" class="form-radio text-indigo-600 focus:ring-indigo-500">
                            <span class="ml-2 text-sm text-slate-700">Pilih Cabang</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" x-model="statusData.location_type" value="city" class="form-radio text-indigo-600 focus:ring-indigo-500">
                            <span class="ml-2 text-sm text-slate-700">Ketik Kota Bebas</span>
                        </label>
                    </div>

                    <div x-show="statusData.location_type === 'branch'">
                        <select name="branch_id" id="ts_branch_select" class="w-full">
                        ...
                        <div class="bg-white border border-slate-200 p-4 rounded-xl shadow-sm relative">
                            ...
                            <div x-show="editingHistoryId === hist.id" style="display: none;">
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        <label class="block text-xs font-semibold text-slate-600 mb-2">Lokasi Riwayat</label>
                                        <div class="flex items-center gap-4 mb-2">
                                            <label class="inline-flex items-center">
                                                <input type="radio" x-model="editHistoryForm.location_type" value="branch" class="form-radio text-indigo-600 focus:ring-indigo-500">
                                                <span class="ml-1 text-xs text-slate-700">Cabang</span>
                                            </label>
                                            <label class="inline-flex items-center">
                                                <input type="radio" x-model="editHistoryForm.location_type" value="city" class="form-radio text-indigo-600 focus:ring-indigo-500">
                                                <span class="ml-1 text-xs text-slate-700">Kota Lain</span>
                                            </label>
                                        </div>
                                        <div x-show="editHistoryForm.location_type === 'branch'">
        ...
        return {
            ...
            editHistory(hist) {
                ...
                this.editHistoryForm = {
                    ...
                    city_name: hist.city_name || '',
                    location_type: (hist.city_name) ? 'city' : 'branch',
            ...
            saveHistoryEdit() {
                ...
                if (this.editHistoryForm.location_type === 'branch') {
                    formData.append('branch_id', this.editHistoryForm.branch_id);
                } else {
                    formData.append('city_name', this.editHistoryForm.city_name);
                }
